...
use keylib_sys::credential::{Credential, Extensions, RelyingParty, User};
use keylib_sys::error;
...
fn test_credential_storage_and_retrieval() {
    ...
    let test_cred = Credential {
        ...
        user: keylib_sys::credential::User {
            id: b"test_user_123".to_vec(),
            name: "testuser".to_string(),
            display_name: Some("Test User".to_string()),
        },
        rp: keylib_sys::credential::RelyingParty {
        ...
        created: 1234567890,
        discoverable: true,
        extensions: keylib_sys::credential::Extensions::default(),
    };
    ...
    match retrieved_cred {
        Some(cred) => {
            ...
            println!("🎉 All tests passed! Credential storage and retrieval working correctly.");
        }
        None => {
